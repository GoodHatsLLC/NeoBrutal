...
struct SnapshotApp {
  static func main() async {
    print("🎨 NeoBrutal UI Snapshot Generator")
    print("=====================================\n")
  ...
  static func themesToTest() -> [NeoBrutalTheme] {
    ...
    return NeoBrutal.standardThemes
  }
  ...
  static func themeByName(_ name: String) -> NeoBrutalTheme? {
    NeoBrutal.standardThemes.first(where: { $0.name.lowercased() == name.lowercased() })
  }
