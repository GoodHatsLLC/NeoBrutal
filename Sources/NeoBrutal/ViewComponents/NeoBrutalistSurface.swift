...
public struct NeoBrutalSurfaceModifier: ViewModifier {
...
extension View {
  ...
  public func neoBrutalSurface(
    accentEdge: NeoBrutalSurfaceModifier.AccentEdge? = .trailing,
    highlighted: Bool = false
  ) -> some View {
    modifier(NeoBrutalSurfaceModifier(accentEdge: accentEdge, isHighlighted: highlighted))
  }
}

extension NeoBrutalSurfaceModifier.AccentEdge? {
