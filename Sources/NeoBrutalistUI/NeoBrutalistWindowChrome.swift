...
public struct NeoBrutalistWindowChrome: View {
    ...
    public init<Accessory: View>(title: String, subtitle: String? = nil, @ViewBuilder accessory: () -> Accessory) {
        self.title = title
        self.subtitle = subtitle
    ...
    private var background: some View {
        Rectangle()
            ...
            .overlay(
                Rectangle()
                    .stroke(theme.surface.secondary.color.opacity(0.75), lineWidth: theme.borderWidth)
            )
                    ...
                    Text(subtitle.uppercased())
                        ...
                        .background(
                            Capsule(style: .continuous)
                                ...
                                .overlay(
                                    Capsule(style: .continuous)
                                        .stroke(theme.surface.highlight.color.opacity(0.65), lineWidth: max(theme.borderWidth * 0.8, 1))
                                )
                        )
                }
            }
    ...
    private func controlButton(_ control: WindowControl) -> some View {
        Button {
            ...
            Circle()
                ...
                .overlay(
                    Circle()
                        .stroke(theme.surface.secondary.color.opacity(0.85), lineWidth: max(theme.borderWidth * 0.6, 1))
                )
                .overlay(control.icon(for: theme))
...
private enum WindowControl {
    ...
    func fill(for theme: NeoBrutalistTheme) -> Color {
        switch self {
        case .close:
            return theme.accent.primary.color
        case .miniaturize:
            return theme.surface.secondary.color
        case .zoom:
            return theme.accent.highlight.color
        }
    }
    ...
    func icon(for theme: NeoBrutalistTheme) -> some View {
        Image(systemName: symbolName)
            ...
            .foregroundColor(theme.surface.highlight.color.opacity(0.9))
    }
