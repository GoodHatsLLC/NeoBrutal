...
extension NeoBrutalistTheme {
    ...
    public static var midnightCitrus: NeoBrutalistTheme {
       NeoBrutalistTheme(
         name: "midnightCitrus",
         light: Variant(
    ...
    public static var cherryBlossom: NeoBrutalistTheme {
       NeoBrutalistTheme(
         name: "cherryBlossom",
         light: Variant(
           background: .hierarchy(
    ...
    public static var cyberPunk: NeoBrutalistTheme {
       NeoBrutalistTheme(
         name: "cyberPunk",
         light: Variant(
           background: .hierarchy(
    ...
    public static var desertStorm: NeoBrutalistTheme {
       NeoBrutalistTheme(
         name: "desertStorm",
         light: Variant(
           background: .hierarchy(
    ...
    public static var arcticFrost: NeoBrutalistTheme {
       NeoBrutalistTheme(
         name: "arcticFrost",
         light: Variant(
           background: .hierarchy(
