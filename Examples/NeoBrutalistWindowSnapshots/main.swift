...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        guard args.count >= 4 else {
            print("Usage: NeoBrutalistWindowSnapshots <theme> <window-type> <title> [subtitle] [--timeout=seconds]")
    ...
    @MainActor
    func createWindow(type: String, title: String, subtitle: String, theme: NeoBrutalistTheme) -> NSWindow {
        let content: AnyView
    ...
    func createNeoBrutalistWindow<Content: View>(
        ...
        window.styleMask = [NSWindow.StyleMask.closable, .miniaturizable, .resizable, .fullSizeContentView]
